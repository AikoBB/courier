...
class DeliversFragment : CoreFragment<CargoListVM>(CargoListVM::class.java, R.layout.activity_cargo_list),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbar.initForActivity(activity, getString(R.string.label_delivers))
        ...
        viewModel.event.observe(this, Observer {
            when (it) {
                is CargoEvent.CargoListFetched -> adapter.addManageableCargoes(
                    it.cargoes.delivers,
                    getString(R.string.label_no_delivers)
                )
